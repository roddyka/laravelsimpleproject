    ...
    <body class="antialiased">
        ...
        <div class="box_tasks">  
            ...
            <div class="basis">
                ...
                <h2>Add new item</h2>
                <form action="{{ route('saveItem') }}" method="post" class="addToListForm">
                    {{csrf_field()}}
                    
                    <label for="nameItem">Name</label>
                    <input type="text" name="nameItem">
                    <label for="descriptionItem">Description</label>
                    <textarea name="descriptionItem" id="descriptionItem" cols="30" rows="10"></textarea>
                    <label for="deliveryItem">Delivery Item</label>
                    <input type="date" name="deliveryItem" id="deliveryItem">
                    <button class="btn_color btn_color_t">Add to list</button>
                </form>
            </div> 
                <div class="basis">
                ...
                <div class="task ">
                    ...
                    <div class="flex itemfromlist itemToDo itemgap" draggable="true" ondragstart="drag(event)">
                        ...
                        <p>Delivery Date: <?php echo date('F jS, Y', strtotime($listItem->delivery_time)); ?></p>
                        <form action="{{ route('markDoing', $listItem->id) }}" method="post">
                        {{csrf_field()}}    
                        <button type="submit" class="btn_color btn_color_d">Mark Doing</button>
                        </form>
                    </div>
                ...
                <div class="task ">
                    ...
                    <div class="flex itemfromlist itemDoing itemgap" draggable="true" ondragstart="drag(event)">
                        ...
                        {{csrf_field()}}    
                        <button type="submit" class="btn_color btn_color_c">Mark Complete</button>
                        </form>
                    </div>
                ...
                <div class="task">
                    ...
                    <div class="flex itemfromlist itemComplete itemgap" draggable="true" ondragstart="drag(event)">
                        ...
                        <form action="{{ route('markDoing', $listItem->id) }}" method="post">
                        {{csrf_field()}}    
                        <button type="submit" class="btn_color btn_color_d">Back to List</button>
                        </form>
                    </div>
                    @endforeach
